...
export const regions = [
  ...
  // seo/content keys (kvemoKartli) so the seoData.js object key needs no quoting.
  {
    ...
    thingsToDo: {
      ...
      // Cover/hero = the Diamond Bridge over Dashbashi Canyon, replacing the
      // generic georgia-home.jpg placeholder this guide shipped with. It is named
      // in the page's own H1 and is the only subject on the page with any
      // photography at all.
      //
      // ⚠️ DELIBERATE duplication, owner-approved and unavoidable: this frame is
      // also the Kvemo Kartli region hero and the Tsalka/Dashbashi Canyon hero.
      // Every encoded Kvemo Kartli photograph is committed to a page. The one
      // large unused set — 22 raw Rustavi Central Park / Fortress frames, which a
      // filename-based scan misses because they are named 1.jpg..22.jpg — is
      // unusable here: this page mentions Rustavi only as a bus-transport note
      // ("Rustavi is under an hour by public bus"), never as somewhere to visit.
      //
      // All rungs already exist at /images/kvemo-kartli WITHOUT the `w` suffix, so
      // every file is REFERENCED in place: nothing copied, nothing generated.
      // Native width is 1445 → top rung 1445, no 1600.
      image: '/images/kvemo-kartli/diamond-bridge-dashbashi-canyon-georgia-1445.webp',
      imageAvif: '/images/kvemo-kartli/diamond-bridge-dashbashi-canyon-georgia-1445.avif',
      heroClass: 'hero--things-to-do-kvemo-kartli',
      heroPreload: '/images/kvemo-kartli/diamond-bridge-dashbashi-canyon-georgia-1200.avif',
      // No `ogImage`: no 1.91:1 file exists for this frame, and the Kvemo Kartli
      // region page likewise auto-derives og:image from `image`. Consistent with
      // the Adjara guide (the Batumi/Imereti/Kakheti guides only carry a dedicated
      // ogImage because one had already been built for their hero).
      //
      // Strings below are the Kvemo Kartli region page's approved sets, reused
      // VERBATIM. Unusually for this page family they needed no re-derivation:
      // their exonyms already match this page's body exactly — Latin `Kvemo
      // Kartli`/`Dashbashi`/`Tsalka` in all 7, plus de `Diamantbrücke`,
      // fr `pont de Diamant`, es `puente de Diamante`, nl `Diamanten brug`,
      // cs `Diamantový most`, pl `Diamentowy Most`.
      // ⚠️ Polish is `Diament-`, not `Diamant-`; a `/diamant/` check silently
      // misses it (that exact false negative bit the region-page pass).
      imageMeta: {
        width: 1445, height: 1088, imageId: 'hero-image',
        name: 'Diamond Bridge over Dashbashi Canyon, Kvemo Kartli, Georgia',
        description: 'The glass Diamond Bridge spanning Dashbashi Canyon near Tsalka, with the volcanic plateau of the western uplands beyond, in the Kvemo Kartli region of Georgia.',
        locationName: 'Dashbashi Canyon Diamond Bridge, Kvemo Kartli, Georgia',
        locality: 'Tsalka', region: 'Kvemo Kartli', country: 'GE',
        geo: { lat: 41.6394, lng: 44.1103 },
        alt: {
          en: 'The Diamond Bridge glass walkway over Dashbashi Canyon near Tsalka, Kvemo Kartli, Georgia',
          de: 'Der gläserne Steg der Diamantbrücke über der Dashbashi-Schlucht bei Tsalka, Kvemo Kartli, Georgien',
          fr: "La passerelle de verre du pont de Diamant au-dessus du canyon de Dashbashi, près de Tsalka, Kvemo Kartli, Géorgie",
        ...
        caption: {
          en: 'The glass Diamond Bridge spans Dashbashi Canyon near Tsalka, with the volcanic plateau of the western uplands beyond.',
          de: 'Die gläserne Diamantbrücke überspannt die Dashbashi-Schlucht bei Tsalka, dahinter das vulkanische Plateau der westlichen Hochländer.',
          fr: "Le pont de Diamant en verre franchit le canyon de Dashbashi près de Tsalka, le plateau volcanique des hauts plateaux occidentaux au fond.",
          es: 'El puente de Diamante de cristal cruza el cañón de Dashbashi cerca de Tsalka, con la meseta volcánica de las tierras altas occidentales al fondo.',
          nl: 'De glazen Diamanten brug overspant de Dashbashi-kloof bij Tsalka, met daarachter het vulkanische plateau van de westelijke hooglanden.',
          cs: 'Skleněný Diamantový most překlenuje kaňon Dashbashi poblíž města Tsalka, za ním se rozkládá sopečná plošina západních vrchovin.',
      ...
      // Two contextual body photos, both referenced in place. The glass café sits
      // under the Dashbashi section that explicitly describes it; the canyon frame
      // sits under the open-plateau-landscapes section, which is what that photo
      // actually shows — rolling green upland above a rocky gorge. Its caption
      // names Dashbashi so nothing broader is implied.
      //
      // Nine of the ten sections stay image-free. No photograph exists anywhere in
      // the project for the Dmanisi excavation site, Bolnisi Sioni Cathedral, the
      // region's multicultural character (no mosque or khachkar frame) or the
      // lesser-known sites. REJECTED as misleading rather than used: the Diamond
      // Restaurant frame (large readable commercial signage, and the page's "glass
      // café" is the capsule on the bridge, not that building) and the Bolnisi
      // museum's Dmanisi hominin reconstruction (a museum display; the page's
      // Dmanisi section is about visiting the excavation site, and it never
      // mentions that museum).
      //
      // Brand credit throughout, mirroring the region page — these exact files
      // already assert it there.
      inlineImageObjects: [
        {
          base: 'diamond-bridge-glass-capsule-dashbashi-canyon-georgia', width: 1086, height: 1448,
          anchor: 'inline-glass-cafe', dir: '/images/kvemo-kartli',
          description: 'The diamond-shaped glass café suspended at the centre of the Diamond Bridge, high above Dashbashi Canyon near Tsalka, in the Kvemo Kartli region of Georgia.',
          locationName: 'Dashbashi Canyon Diamond Bridge, Kvemo Kartli, Georgia',
          locality: 'Tsalka', region: 'Kvemo Kartli', geo: { lat: 41.6394, lng: 44.1103 },
          name: {
            en: 'The diamond-shaped glass café suspended beneath the Diamond Bridge, Dashbashi Canyon, Georgia',
        ...
        },
        {
          base: 'dashbashi-canyon-zipline-georgia', width: 1445, height: 1088,
          anchor: 'inline-canyon', dir: '/images/kvemo-kartli',
          description: 'The basalt walls and green slopes of Dashbashi Canyon, cut by the Khrami River through a volcanic plateau near Tsalka, with the open upland grassland above, in the Kvemo Kartli region of Georgia.',
          locationName: 'Dashbashi Canyon, Kvemo Kartli, Georgia',
          locality: 'Tsalka', region: 'Kvemo Kartli', geo: { lat: 41.6394, lng: 44.1103 },
          name: {
            en: 'The basalt walls and green slopes of Dashbashi Canyon near Tsalka, Kvemo Kartli, Georgia',
            de: 'Die Basaltwände und grünen Hänge der Dashbashi-Schlucht bei Tsalka, Kvemo Kartli, Georgien',
          ...
          caption: {
            en: 'Open upland grassland runs right to the rim of Dashbashi Canyon, where the plateau drops away in basalt walls.',
            de: 'Offenes Hochlandgrasland reicht bis an den Rand der Dashbashi-Schlucht, wo das Plateau in Basaltwänden abfällt.',
            fr: "Les prairies des hauts plateaux s'étendent jusqu'au bord du canyon de Dashbashi, où le plateau s'effondre en parois de basalte.",
            es: 'Los pastizales de las tierras altas llegan hasta el borde del cañón de Dashbashi, donde la meseta cae en paredes de basalto.',
            nl: 'Open hooglandgrasland loopt door tot aan de rand van de Dashbashi-kloof, waar het plateau in basaltwanden wegvalt.',
            cs: 'Otevřené horské pastviny sahají až k okraji kaňonu Dashbashi, kde plošina spadá čedičovými stěnami.',
            pl: 'Otwarte wyżynne pastwiska sięgają aż po krawędź kanionu Dashbashi, gdzie płaskowyż opada bazaltowymi ścianami.',
          },
        },
      ],
  ...
  // quoting.
  {
    ...
    thingsToDo: {
      ...
      // Cover/hero = the Vardzia cliff-face frame, REPLACING the raw
      // /images/files/vardzia-cave-monastery.jpg. Same subject, but a genuinely
      // DIFFERENT photograph — verified by viewing both rather than by filename:
      // the old one is flat, overcast and distant with no clear subject; this one
      // shows the rock-cut church facade, terraces and stairways above the Mtkvari
      // valley in warm light. The raw JPG is NOT deleted; it is referenced elsewhere.
      //
      // ⚠️ DELIBERATE duplication, owner-approved and unavoidable: this frame is
      // also the region hero and the Vardzia site-page hero, so the guide is its
      // third use. Every Samtskhe-Javakheti photograph in the project is committed
      // to a page. All five images here ship no-`w` filenames with complete
      // 768/1200/1448 ladders, so every one is REFERENCED in place — nothing
      // copied, nothing generated. Native 1448 → top rung 1448, no 1600.
      image: '/images/files/vardzia-cave-monastery-cliff-face-georgia-1448.webp',
      imageAvif: '/images/files/vardzia-cave-monastery-cliff-face-georgia-1448.avif',
      heroClass: 'hero--things-to-do-samtskhe-javakheti',
      heroPreload: '/images/files/vardzia-cave-monastery-cliff-face-georgia-1200.avif',
      // Dedicated 1.91:1 social image, already built for the Vardzia site page.
      ogImage: { src: '/images/files/vardzia-cave-monastery-cliff-face-georgia-og.jpg', width: 1200, height: 630 },
      // ⚠️ NAMING — unusually clean here. This page writes every place name in
      // Latin form in ALL 7 locales (Vardzia, Rabati, Akhaltsikhe, Khertvisi,
      // Paravani, Mtkvari, Samtskhe-Javakheti), and the region page's approved
      // sets already match, so they are reused VERBATIM. The `Achalziche` form on
      // the Rabati SITE page does not reach here — the region page had already
      // re-derived away from it. Single deliberate deviation: the region page
      // writes Dutch `fort` for the two fortresses while this page's body uses
      // `vesting` 14x, so those two nl strings are aligned to the page they sit on.
      imageMeta: {
        width: 1448, height: 1086, imageId: 'hero-image',
        name: 'The cave monastery of Vardzia carved into the cliffs above the Mtkvari valley, Samtskhe-Javakheti, Georgia',
        description: 'The cave monastery of Vardzia, its chambers and a stone church cut into the cliff face above the Mtkvari valley, Samtskhe-Javakheti, Georgia.',
        locationName: 'Vardzia, Aspindza Municipality, Samtskhe-Javakheti, Georgia',
      ...
      // Four contextual body photos, one per section, all REFERENCED in place:
      // Vardzia (4), Rabati (6), the Javakheti plateau (10), Khertvisi (12).
      // All four are brand-credited on the region page and keep that here.
      //
      // Seven of the eleven sections stay image-free. REJECTED rather than
      // stretched: all five Bakuriani frames plus any Abastumani or Sapara image,
      // because this page NEVER mentions those places (0 occurrences each — the
      // same finding as the region page); borjomi-town.jpg, which on inspection is
      // a snowy suburban back street crossed by overhead power lines, showing none
      // of the spa town, mineral-water park or forest trails its paragraph
      // describes (and it is a raw with no ladder); and
      // akhaltsikhe-rabati-fortress-ramparts-georgia, a good frame but the
      // Akhaltsikhe city-page hero duplicating a subject already covered.
      // No photograph of Vanis Kvabebi exists anywhere.
      inlineImageObjects: [
        {
          base: 'vardzia-cave-monastery-mtkvari-valley-georgia', width: 1448, height: 1086,
          anchor: 'inline-vardzia-valley',
        ...
        },
        {
          ...
          name: {
            ...
            fr: "La forteresse de Rabati sur sa colline au-dessus d'Akhaltsikhe, Samtskhe-Javakheti, Géorgie",
            es: 'La fortaleza de Rabati en su colina sobre Akhaltsikhe, Samtskhe-Javakheti, Georgia',
            // `vesting`, not the region page's `fort`: this page's body uses
            // `vesting` 14x and `fort` never.
            nl: 'De vesting Rabati op haar heuvel boven Akhaltsikhe, Samtskhe-Javakheti, Georgië',
            cs: 'Pevnost Rabati na návrší nad Akhaltsikhe, Samtskhe-Javakheti, Gruzie',
            pl: 'Twierdza Rabati na wzgórzu nad Akhaltsikhe, Samtskhe-Javakheti, Gruzja',
          },
          caption: {
        ...
        },
        {
          ...
          description: 'Lake Paravani on the open volcanic grassland of the Javakheti plateau, ringed by low rounded hills, Samtskhe-Javakheti, Georgia.',
          locationName: 'Lake Paravani, Ninotsminda Municipality, Samtskhe-Javakheti, Georgia',
          locality: 'Ninotsminda Municipality', region: 'Samtskhe-Javakheti', geo: { lat: 41.45, lng: 43.7833 },
          name: {
            en: 'Lake Paravani on the open volcanic grassland of the Javakheti plateau, Samtskhe-Javakheti, Georgia',
            de: 'Der Paravani-See im offenen vulkanischen Grasland der Hochebene von Javakheti, Samtskhe-Javakheti, Georgien',
            fr: "Le lac Paravani dans les prairies volcaniques ouvertes du plateau du Javakheti, Samtskhe-Javakheti, Géorgie",
        ...
        },
        {
          ...
          name: {
            ...
            fr: "Les tours et les courtines de la forteresse de Khertvisi sur sa crête, Samtskhe-Javakheti, Géorgie",
            es: 'Las torres y murallas de la fortaleza de Khertvisi sobre su cresta, Samtskhe-Javakheti, Georgia',
            // `vesting`, not the region page's `fort` — see the Rabati note above.
            nl: 'De torens en muren van de vesting Khertvisi op haar bergrug, Samtskhe-Javakheti, Georgië',
            cs: 'Věže a hradby pevnosti Khertvisi na jejím hřebeni, Samtskhe-Javakheti, Gruzie',
            pl: 'Wieże i mury twierdzy Khertvisi na grani, Samtskhe-Javakheti, Gruzja',
          },
          caption: {
            ...
            fr: "La forteresse de Khertvisi tient sa crête au-dessus de la gorge du Mtkvari, ses tours et ses courtines épousant le rocher.",
            es: 'La fortaleza de Khertvisi domina su cresta sobre el desfiladero del Mtkvari, con torres y murallas que siguen la roca.',
            nl: 'De vesting Khertvisi beheerst haar bergrug boven de Mtkvari-kloof, met torens en muren die de rots volgen.',
            cs: 'Pevnost Khertvisi drží svůj hřeben nad soutěskou Mtkvari, její věže a hradby sledují skálu.',
            pl: 'Twierdza Khertvisi trzyma swoją grań nad wąwozem Mtkvari, a jej wieże i mury podążają za skałą.',
          },
        },
  ...
  // seo/content keys (shidaKartli) so the seoData.js key needs no quoting.
  {
    ...
    // Cover/hero = the view from the carved plateau at Uplistsikhe out over the
    // Mtkvari valley, replacing the flat, washed-out Uplistsikhe Cave Town.jpg the
    // page shipped with. It is the only broad LANDSCAPE in the region's photo set
    // and it matches the page's own opening line ("the broad valley of the Mtkvari
    // River"). The old JPG is NOT deleted — it is still a tours.js frame.
    //
    // ⚠️ Referenced in place: this base uniquely ships BOTH no-`w` (768/1200/1448)
    // and `-1600w` rungs, and the no-`w` set is what inlineImageObjects builds, so
    // the hero needs no copy. It duplicates an INLINE on the Uplistsikhe site page
    // (not that page's hero, which is the Prince's Church basilica).
    //
    ...
    // fixed BLOCK INDEX (all 7 locales share a 28-block shape).
    //
    // ⚠️ The `w`-suffix convention is INCONSISTENT within this region, so
    // copy-vs-reference differs per image: the hero is referenced in place, while
    // the three inlines ship only `-<w>w` names and were therefore COPIED
    // byte-for-byte into /images/shida-kartli/ under the no-`w` name (18 files,
    // verified identical to source — nothing re-encoded, nothing upscaled).
    // Note the Gori fortress ceiling is 1264, not 1448 — that is its native width.
    //
    // Brand credit is kept: all four already assert Hikasus authorship on their
    // own pages. Names, locations and coordinates are reused from those entries.
    //
    // ⚠️ SENSITIVE GEOGRAPHY: this page discusses South Ossetia/Tskhinvali and the
    // 2008 conflict in blocks 7 and 21. NO image is placed at either block, no
    // occupied-territory imagery is used, and no political or geographic wording
    // is touched by this change.
    //
    // Sections left image-free: Ateni Sioni (4 blocks — NO photograph exists; that
    // site's own page is still on georgia-home.jpg), the landscape section, and
    // Mtskheta (its images belong to the Mtskheta-Mtianeti region). The Stalin
    // Museum is named in block 13 and an unused interior photo exists, but the
    // owner chose to leave it to the museum's own page.
    inlineImageObjects: [
      {
        // No `dir` — the no-`w` rungs already live at the default /images/files/.
        base: 'uplistsikhe-mtkvari-valley-view-georgia', width: 1448, height: 1086,
        anchor: 'hero-image', hero: true,
      ...
      {
        // Native width 1264 — that is the ladder ceiling, there is no 1448 rung.
      ...
      },
      {
        ...
        anchor: 'inline-gori-town', dir: '/images/shida-kartli',
  ...
  // keys are plain `svaneti`.
  {
    ...
    thingsToDo: {
      ...
      // Cover/hero = Ushguli's Svan towers, REPLACING /images/files/Koruldi
      // Lakes.jpg. The swap is about RELEVANCE, not quality: that frame shows the
      // Koruldi Lakes and this page never mentions Koruldi (0 occurrences in any
      // locale), while it names Ushguli 30x, Mestia 30x and Svan towers 11x. The
      // old JPG also has a hiker prominent in the foreground and is the region
      // page's hero; it is NOT deleted, the region page still references it.
      //
      // ⚠️ DELIBERATE duplication, owner-approved: this frame is also the Ushguli
      // page hero. No unused Svaneti photograph is available — the only two are
      // the Ushguli panorama (provenance HELD) and svaneti-horse-riding (flagged
      // likely AI-generated and already pulled from the Svaneti page).
      //
      // The hero path keeps its `-<w>w` suffix, which is fine: a hero is a CSS
      // background plus a plain `image:` path. Only inlineImageObjects need
      // no-`w` names, because their contentUrl is built as `<base>-<width>.webp`.
      image: '/images/files/ushguli-svan-towers-village-svaneti-georgia-1600w.webp',
      imageAvif: '/images/files/ushguli-svan-towers-village-svaneti-georgia-1600w.avif',
      heroClass: 'hero--things-to-do-svaneti',
      heroPreload: '/images/files/ushguli-svan-towers-village-svaneti-georgia-1200w.avif',
      // Dedicated 1.91:1 social image, already built for the Ushguli page.
      ogImage: { src: '/images/files/ushguli-svan-towers-village-svaneti-georgia-og-1200x630.jpg', width: 1200, height: 630 },
      // ⚠️ NAMING — this page does NOT use one Latin form everywhere, unlike most
      // of the family. Its own body writes:
      //   Svaneti → de "Swanetien", fr "Svanétie", cs "Svanetii"/"Svanetie";
      //             en/es/nl/pl "Svaneti"
      //   Mestia  → cs "Mestie"/"Mestii", pl "Mestii" (both declined)
      //   Ushguli / Shkhara / Enguri / Lamaria → Latin in all 7
      //   towers  → de Türme, fr tours, es torres, nl torens, cs věže, pl wieże
      // The region page's five imageObjects are ENGLISH-ONLY (older convention),
      // so there was nothing to reuse — all five sets below are authored against
      // the forms above. The splice script and verifier both fail if a bare
      // "Svaneti" reaches German or French.
      imageMeta: {
        width: 2000, height: 1231, imageId: 'hero-image',
        name: 'Svan towers and the village of Ushguli below the Caucasus, Svaneti, Georgia',
        description: 'Stone Svan defensive towers standing among the slate-roofed houses of Ushguli, at the head of the Enguri valley, with green slopes and the Caucasus beyond, in Svaneti, Georgia.',
        locationName: 'Ushguli, Svaneti, Georgia',
        locality: 'Ushguli', region: 'Svaneti', country: 'GE',
        alt: {
          en: 'Svan towers and the village of Ushguli below the Caucasus, Svaneti, Georgia',
          de: 'Swanische Türme und das Dorf Ushguli unterhalb des Kaukasus, Swanetien, Georgien',
          fr: "Tours svanes et le village d'Ushguli sous le Caucase, Svanétie, Géorgie",
          es: 'Torres svanas y la aldea de Ushguli bajo el Cáucaso, Svaneti, Georgia',
          nl: 'Svaanse torens en het dorp Ushguli onder de Kaukasus, Svaneti, Georgië',
          cs: 'Svanské věže a vesnice Ushguli pod Kavkazem, Svanetie, Gruzie',
          pl: 'Swańskie wieże i wieś Ushguli pod Kaukazem, Svaneti, Gruzja',
        },
        caption: {
          en: 'Stone Svan towers stand among the houses of Ushguli, with the valley and the Caucasus beyond.',
          de: 'Steinerne swanische Türme stehen zwischen den Häusern von Ushguli, dahinter das Tal und der Kaukasus.',
          fr: "Des tours svanes en pierre se dressent parmi les maisons d'Ushguli, la vallée et le Caucase au fond.",
          es: 'Torres svanas de piedra se alzan entre las casas de Ushguli, con el valle y el Cáucaso al fondo.',
          nl: 'Stenen Svaanse torens staan tussen de huizen van Ushguli, met daarachter het dal en de Kaukasus.',
          cs: 'Kamenné svanské věže stojí mezi domy Ushguli, za nimi údolí a Kavkaz.',
          pl: 'Kamienne swańskie wieże stoją wśród domów Ushguli, a w tle dolina i Kaukaz.',
        },
      },
      // Four contextual body photos, one per section: the trek (4), the Shkhara
      // day-hike (6), Mestia (10), Ushguli (14). All four duplicate another
      // page's frame — see the hero note. All are brand-credited on their pages.
      //
      // Nine of the thirteen sections stay image-free. REJECTED rather than
      // stretched: svaneti-glacier-valley-georgia, a generic open alpine valley
      // that cannot honestly be labelled Chalaadi (the Chalaadi paragraph
      // describes a forest walk to a glacier snout, which it does not show), so
      // Chalaadi has no image; becho-village-svaneti-georgia, because Becho is
      // never mentioned (the smaller-villages paragraph names only Adishi and
      // Iprari); the generic svaneti-alpine-meadow and svaneti-caucasus-mountains
      // frames; the Ushguli towers panorama (provenance HELD); and
      // svaneti-horse-riding (flagged likely AI-generated). No photograph of
      // Hatsvali or Tetnuldi exists, so the skiing section has none either.
      inlineImageObjects: [
        {
          // Copied byte-for-byte from the `-<w>w` originals; native is a 1024
          // square, so the ladder is 768/1024 and nothing is upscaled.
          base: 'svaneti-hiking-trail-signpost-georgia', width: 1024, height: 1024,
          anchor: 'inline-trek-signpost', dir: '/images/svaneti',
          description: 'A wooden hiking trail signpost on a grassy ridge above Mestia, pointing along the walking routes, with the peaks of Svaneti behind, Georgia.',
          locationName: 'Mestia, Svaneti, Georgia',
          locality: 'Mestia', region: 'Svaneti',
          name: {
            en: 'A hiking trail signpost above Mestia, Svaneti, Georgia',
            de: 'Ein Wanderweg-Wegweiser oberhalb von Mestia, Swanetien, Georgien',
            fr: "Un panneau de sentier de randonnée au-dessus de Mestia, Svanétie, Géorgie",
            es: 'Un poste indicador de sendero sobre Mestia, Svaneti, Georgia',
            nl: 'Een wegwijzer voor wandelpaden boven Mestia, Svaneti, Georgië',
            cs: 'Rozcestník turistických tras nad Mestií, Svanetie, Gruzie',
            pl: 'Drogowskaz szlaków turystycznych nad Mestią, Svaneti, Gruzja',
          },
          caption: {
            en: 'A trail signpost marks the walking routes on the ridge above Mestia, below the peaks.',
            de: 'Ein Wegweiser markiert die Wanderrouten auf dem Bergrücken über Mestia, unterhalb der Gipfel.',
            fr: "Un panneau indique les itinéraires de randonnée sur la crête au-dessus de Mestia, sous les sommets.",
            es: 'Un poste indicador señala las rutas de senderismo en la cresta sobre Mestia, bajo las cumbres.',
            nl: 'Een wegwijzer markeert de wandelroutes op de bergkam boven Mestia, onder de toppen.',
            cs: 'Rozcestník značí turistické trasy na hřebeni nad Mestií, pod vrcholy.',
            pl: 'Drogowskaz wyznacza szlaki na grani nad Mestią, poniżej szczytów.',
          },
        },
        {
          // Referenced in place at /images/files — already no-`w`. PORTRAIT.
          base: 'shkhara-glacier-ushguli-svaneti-georgia', width: 1086, height: 1448,
          anchor: 'inline-shkhara',
          description: 'The Shkhara glacier at the head of the Enguri valley above Ushguli, its ice and moraine below the high Caucasus wall, in Svaneti, Georgia.',
          locationName: 'Shkhara Glacier, Ushguli, Svaneti, Georgia',
          locality: 'Ushguli', region: 'Svaneti',
          name: {
            en: 'The Shkhara glacier at the head of the Enguri valley above Ushguli, Svaneti, Georgia',
            de: 'Der Shkhara-Gletscher am Talschluss des Enguri oberhalb von Ushguli, Swanetien, Georgien',
            fr: "Le glacier de Shkhara au fond de la vallée de l'Enguri au-dessus d'Ushguli, Svanétie, Géorgie",
            es: 'El glaciar de Shkhara en la cabecera del valle del Enguri sobre Ushguli, Svaneti, Georgia',
            nl: 'De Shkhara-gletsjer aan het einde van het Enguri-dal boven Ushguli, Svaneti, Georgië',
            cs: 'Ledovec Shkhara v závěru údolí Enguri nad Ushguli, Svanetie, Gruzie',
            pl: 'Lodowiec Shkhara u szczytu doliny Enguri nad Ushguli, Svaneti, Gruzja',
          },
          caption: {
            en: 'The Shkhara glacier fills the head of the Enguri valley, a day-hike upstream from Ushguli.',
            de: 'Der Shkhara-Gletscher füllt den Talschluss des Enguri, eine Tageswanderung flussaufwärts von Ushguli.',
            fr: "Le glacier de Shkhara occupe le fond de la vallée de l'Enguri, à une journée de marche en amont d'Ushguli.",
            es: 'El glaciar de Shkhara ocupa la cabecera del valle del Enguri, a una jornada de marcha aguas arriba de Ushguli.',
            nl: 'De Shkhara-gletsjer vult het einde van het Enguri-dal, een dagwandeling stroomopwaarts vanaf Ushguli.',
            cs: 'Ledovec Shkhara vyplňuje závěr údolí Enguri, den chůze proti proudu od Ushguli.',
            pl: 'Lodowiec Shkhara wypełnia szczyt doliny Enguri, dzień marszu w górę rzeki od Ushguli.',
          },
        },
        {
          // Referenced in place at /images/files — already no-`w`.
          base: 'mestia-svan-tower-houses-svaneti-georgia', width: 1541, height: 1020,
          anchor: 'inline-mestia',
          description: 'Stone Svan tower houses rising among the roofs of Mestia, against the forested slopes of the surrounding mountains, in Svaneti, Georgia.',
          locationName: 'Mestia, Svaneti, Georgia',
          locality: 'Mestia', region: 'Svaneti',
          name: {
            en: 'Stone Svan tower houses in Mestia, Svaneti, Georgia',
            de: 'Steinerne swanische Wohntürme in Mestia, Swanetien, Georgien',
            fr: "Maisons-tours svanes en pierre à Mestia, Svanétie, Géorgie",
            es: 'Casas torre svanas de piedra en Mestia, Svaneti, Georgia',
            nl: 'Stenen Svaanse woontorens in Mestia, Svaneti, Georgië',
            cs: 'Kamenné svanské obytné věže v Mestii, Svanetie, Gruzie',
            pl: 'Kamienne swańskie wieże mieszkalne w Mestii, Svaneti, Gruzja',
          },
          caption: {
            en: 'Svan tower houses rise among the roofs of Mestia, against the forested slopes behind.',
            de: 'Swanische Wohntürme ragen zwischen den Dächern von Mestia auf, dahinter die bewaldeten Hänge.',
            fr: "Des maisons-tours svanes s'élèvent parmi les toits de Mestia, sur fond de versants boisés.",
            es: 'Las casas torre svanas se alzan entre los tejados de Mestia, con las laderas boscosas detrás.',
            nl: 'Svaanse woontorens rijzen op tussen de daken van Mestia, tegen de beboste hellingen erachter.',
            cs: 'Svanské obytné věže se tyčí mezi střechami Mestie, za nimi zalesněné svahy.',
            pl: 'Swańskie wieże mieszkalne wznoszą się wśród dachów Mestii, na tle zalesionych zboczy.',
          },
        },
        {
          // Copied byte-for-byte from the `-<w>w` originals. Native 1217.
          base: 'ushguli-village-shkhara-svaneti-georgia', width: 1217, height: 864,
          anchor: 'inline-ushguli-shkhara', dir: '/images/svaneti',
          description: 'The houses and towers of Ushguli spread across the valley floor, with the snow-covered wall of Mount Shkhara closing the head of the valley behind, in Svaneti, Georgia.',
          locationName: 'Ushguli, Svaneti, Georgia',
          locality: 'Ushguli', region: 'Svaneti',
          name: {
            en: 'Ushguli village with Mount Shkhara behind, Svaneti, Georgia',
            de: 'Das Dorf Ushguli mit dem Shkhara dahinter, Swanetien, Georgien',
            fr: "Le village d'Ushguli avec le mont Shkhara en arrière-plan, Svanétie, Géorgie",
            es: 'La aldea de Ushguli con el monte Shkhara al fondo, Svaneti, Georgia',
            nl: 'Het dorp Ushguli met de Shkhara erachter, Svaneti, Georgië',
            cs: 'Vesnice Ushguli s horou Shkhara v pozadí, Svanetie, Gruzie',
            pl: 'Wieś Ushguli z górą Shkhara w tle, Svaneti, Gruzja',
          },
          caption: {
            en: 'The houses and towers of Ushguli spread across the valley, with the snow of Shkhara closing it behind.',
            de: 'Die Häuser und Türme von Ushguli breiten sich über das Tal aus, dahinter schließt der verschneite Shkhara es ab.',
            fr: "Les maisons et les tours d'Ushguli s'étendent dans la vallée, que ferme au fond le Shkhara enneigé.",
            es: 'Las casas y torres de Ushguli se extienden por el valle, cerrado al fondo por la nieve del Shkhara.',
            nl: 'De huizen en torens van Ushguli liggen verspreid over het dal, dat achteraan wordt afgesloten door de besneeuwde Shkhara.',
            cs: 'Domy a věže Ushguli se rozprostírají údolím, které v pozadí uzavírá zasněžená Shkhara.',
            pl: 'Domy i wieże Ushguli rozciągają się w dolinie, którą w tle zamyka ośnieżona Shkhara.',
          },
        },
      ],
...
export const cities = [
  ...
  },
  {
    ...
    thingsToDo: {
      seoKey: 'thingsToDoAkhaltsikhe', contentKey: 'thingsToDoAkhaltsikhe',
      // Cover/hero = the Rabati ramparts frame, REPLACING the generic
      // georgia-home.jpg placeholder this guide shipped with. Deliberately the
      // broad "in Akhaltsikhe" view — ramparts, watchtower, citadel, the complex
      // roofs and the hills around the town — rather than a single-monument
      // portrait, because the H1 is "Things to Do in Akhaltsikhe … Rabati,
      // Vardzia, and Nearby Sites". The head-on complex shot is spent inline
      // instead, where it literally illustrates the Rabati paragraph.
      //
      // ⚠️ DELIBERATE duplication, owner-approved and unavoidable: this frame is
      // also the Akhaltsikhe CITY page hero. Every Akhaltsikhe / Samtskhe-Javakheti
      // photograph in the project is already committed to a page (the alternative,
      // rabati-fortress-akhaltsikhe-georgia, is the Rabati Fortress page's hero),
      // and tours.js carries none. Same call the Imereti and Samtskhe-Javakheti
      // hubs made. All five images here already ship no-`w` filenames with complete
      // 768/1200/1448 ladders, so every one is REFERENCED in place — nothing
      // copied, nothing generated, nothing re-encoded. Native 1448 → top rung
      // 1448, NO 1600/2400 rung, no upscale.
      image: '/images/files/akhaltsikhe-rabati-fortress-ramparts-georgia-1448.webp',
      imageAvif: '/images/files/akhaltsikhe-rabati-fortress-ramparts-georgia-1448.avif',
      heroClass: 'hero--things-to-do-akhaltsikhe',
      heroPreload: '/images/files/akhaltsikhe-rabati-fortress-ramparts-georgia-1200.avif',
      // Dedicated 1.91:1 social image, already built for the city page. Without
      // it og:image fell back to the georgia-home.jpg placeholder.
      ogImage: { src: '/images/files/akhaltsikhe-rabati-fortress-ramparts-georgia-og.jpg', width: 1200, height: 630 },
      // ⚠️ NAMING — this page is the OPPOSITE of the Akhaltsikhe city page, whose
      // imageMeta uses exonyms (Achalziche / Ajaltsije / Achaltsiche / Achalciche /
      // Achalcyche). This guide's body writes Akhaltsikhe in LATIN in all 7
      // locales, so none of the city page's strings are reused — every one is
      // re-derived. Two further page-local deviations from the Samtskhe-Javakheti
      // guide's approved sets: this page calls Rabati a CASTLE (en Castle, fr
      // château, es castillo, nl kasteel, cs hrad, pl zamek; only de keeps
      // Festung), and its German body spells the river Mtkwari, not Mtkvari.
      // Khertvisi is nl `fort` here, not the sibling's `vesting`. Vocabulary
      // follows the page each string sits on.
      imageMeta: {
        width: 1448, height: 1086, imageId: 'hero-image',
        name: 'The ramparts of Rabati Castle above Akhaltsikhe, a round stone tower and the citadel beyond in evening light, Georgia',
        description: 'A view along the crenellated ramparts of Rabati Castle above the town of Akhaltsikhe, with a round stone watchtower in the foreground and the flag-topped citadel beyond, in warm evening light with green hills to the left. Akhaltsikhe is the capital of the Samtskhe-Javakheti region of southern Georgia (the country).',
        locationName: 'Akhaltsikhe, Samtskhe-Javakheti, Georgia',
        locality: 'Akhaltsikhe', region: 'Samtskhe-Javakheti', country: 'GE',
        // Pinned to the Akhaltsikhe TOWN CENTRE, deliberately distinct from the
        // Rabati Fortress page's coordinate (41.64267/42.97706).
        geo: { lat: 41.63889, lng: 42.98528 },
        alt: {
          en: 'The ramparts of Rabati Castle above Akhaltsikhe, a round stone tower and the citadel beyond in evening light, Georgia',
          de: 'Die Wälle der Festung Rabati über Akhaltsikhe, ein runder Steinturm und dahinter die Zitadelle im Abendlicht, Georgien',
          fr: "Les remparts du château de Rabati au-dessus d'Akhaltsikhe, une tour ronde en pierre et la citadelle au loin dans la lumière du soir, Géorgie",
          es: 'Las murallas del castillo Rabati sobre Akhaltsikhe, una torre redonda de piedra y la ciudadela al fondo con luz del atardecer, Georgia',
          nl: 'De wallen van het Rabati-kasteel boven Akhaltsikhe, een ronde stenen toren en daarachter de citadel in het avondlicht, Georgië',
          cs: 'Hradby hradu Rabati nad Akhaltsikhe, kulatá kamenná věž a v pozadí citadela ve večerním světle, Gruzie',
          pl: 'Mury zamku Rabati nad Akhaltsikhe, okrągła kamienna wieża i cytadela w tle w wieczornym świetle, Gruzja',
        },
        caption: {
          en: 'A walk along the ramparts of Rabati Castle above Akhaltsikhe, with a round stone watchtower and the flag-topped citadel beyond in evening light.',
          de: 'Ein Gang über die Wälle der Festung Rabati oberhalb von Akhaltsikhe, mit einem runden steinernen Wachturm und der fahnengekrönten Zitadelle dahinter im Abendlicht.',
          fr: "Une promenade sur les remparts du château de Rabati au-dessus d'Akhaltsikhe, avec une tour de guet ronde en pierre et, au-delà, la citadelle surmontée d'un drapeau dans la lumière du soir.",
          es: 'Un paseo por las murallas del castillo Rabati sobre Akhaltsikhe, con una torre de vigilancia redonda de piedra y, al fondo, la ciudadela coronada por una bandera con luz del atardecer.',
          nl: 'Een wandeling over de wallen van het Rabati-kasteel boven Akhaltsikhe, met een ronde stenen wachttoren en daarachter de met een vlag bekroonde citadel in het avondlicht.',
          cs: 'Procházka po hradbách hradu Rabati nad Akhaltsikhe s kulatou kamennou strážní věží a praporem korunovanou citadelou v pozadí ve večerním světle.',
          pl: 'Spacer po murach zamku Rabati nad Akhaltsikhe, z okrągłą kamienną wieżą strażniczą i zwieńczoną flagą cytadelą w tle w wieczornym świetle.',
        },
      },
      // Four contextual body figures, spliced into each locale's content at a
      // fixed BLOCK INDEX (all 7 locales share a 10-block shape): Rabati (block 2,
      // filling the old IMAGE NEEDED comment), Vardzia twice (block 3 — the
      // cliff-face frame replaces the raw wine-img, the gorge frame closes the
      // section on its "tunnels and stairways … terraces above the valley"
      // paragraph), and Khertvisi (block 4, replacing its raw wine-img). The two
      // superseded raws (vardzia-cave-monastery.jpg, khertvisi-fortress.jpg) are
      // NOT deleted — the Akhaltsikhe city page still shows both.
      //
      // Six sections stay image-free. REJECTED rather than stretched:
      // lake-paravani-javakheti-georgia, a strong frame in the right region, but
      // Paravani, the Javakheti plateau, Akhalkalaki and Ninotsminda are mentioned
      // ZERO times here; all Bakuriani frames (never mentioned); and
      // vardzia-miniature-shekvetili-georgia, which is a scale model in a Guria
      // theme park. NO photograph of Sapara Monastery and NO photograph of
      // Akhaltsikhe's streets exists anywhere in the project, so those two
      // sections keep their honest IMAGE NEEDED marker / stay bare. Block 7's
      // legacy borjomi-town.jpg is left exactly as it was — it is a snowy back
      // street crossed by overhead power lines, but there is no better Borjomi
      // frame to swap in and removing it was out of scope.
      //
      // Brand credit is kept (no `noCredit`): all four already assert Hikasus
      // authorship on their own pages.
      inlineImageObjects: [
        {
          base: 'rabati-fortress-akhaltsikhe-georgia', width: 1448, height: 1086,
          anchor: 'inline-rabati',
          description: 'The Rabati complex on its hilltop above Akhaltsikhe, its ramparts and towers enclosing a mosque, a palace and courtyards, Samtskhe-Javakheti, Georgia.',
          locationName: 'Rabati Fortress (Akhaltsikhe Castle), Akhaltsikhe, Samtskhe-Javakheti, Georgia',
          locality: 'Akhaltsikhe', region: 'Samtskhe-Javakheti', geo: { lat: 41.64267, lng: 42.97706 },
          name: {
            en: 'Rabati Castle on its hilltop above Akhaltsikhe, Samtskhe-Javakheti, Georgia',
            de: 'Die Festung Rabati auf ihrem Hügel über Akhaltsikhe, Samtskhe-Javakheti, Georgien',
            fr: "Le château de Rabati sur sa colline au-dessus d'Akhaltsikhe, Samtskhe-Javakheti, Géorgie",
            es: 'El castillo Rabati en su colina sobre Akhaltsikhe, Samtskhe-Javakheti, Georgia',
            nl: 'Het Rabati-kasteel op zijn heuvel boven Akhaltsikhe, Samtskhe-Javakheti, Georgië',
            cs: 'Hrad Rabati na návrší nad Akhaltsikhe, Samtskhe-Javakheti, Gruzie',
            pl: 'Zamek Rabati na wzgórzu nad Akhaltsikhe, Samtskhe-Javakheti, Gruzja',
          },
          caption: {
            en: 'The Rabati complex fills its hilltop above Akhaltsikhe, its ramparts and towers enclosing a mosque, a palace and courtyards.',
            de: 'Die Anlage von Rabati füllt ihren Hügel über Akhaltsikhe; Wälle und Türme umschließen eine Moschee, einen Palast und Höfe.',
        ...
        {
          base: 'vardzia-cave-monastery-cliff-face-georgia', width: 1448, height: 1086,
          anchor: 'inline-vardzia',
          description: 'The cave monastery of Vardzia, its chambers and a stone church cut into the cliff face above the Mtkvari valley, Samtskhe-Javakheti, Georgia.',
          locationName: 'Vardzia, Aspindza Municipality, Samtskhe-Javakheti, Georgia',
          locality: 'Vardzia', region: 'Samtskhe-Javakheti', geo: { lat: 41.3811, lng: 43.2847 },
          name: {
            en: 'The Vardzia cave monastery carved into the cliffs above the Mtkvari valley, Samtskhe-Javakheti, Georgia',
            // `Mtkwari`: this page's German body spells the river with a w.
            de: 'Das Höhlenkloster Vardzia, in die Felsen über dem Tal des Mtkwari gehauen, Samtskhe-Javakheti, Georgien',
            fr: "Le monastère troglodyte de Vardzia, creusé dans les falaises au-dessus de la vallée du Mtkvari, Samtskhe-Javakheti, Géorgie",
            es: 'El monasterio rupestre de Vardzia, excavado en los acantilados sobre el valle del Mtkvari, Samtskhe-Javakheti, Georgia',
            nl: 'Het grottenklooster Vardzia, uitgehouwen in de rotsen boven het dal van de Mtkvari, Samtskhe-Javakheti, Georgië',
            cs: 'Jeskynní klášter Vardzia vytesaný do skal nad údolím řeky Mtkvari, Samtskhe-Javakheti, Gruzie',
            pl: 'Klasztor jaskiniowy Vardzia wykuty w skałach nad doliną rzeki Mtkvari, Samtskhe-Javakheti, Gruzja',
          },
          caption: {
            en: 'Chambers and a stone church cut into the cliff at Vardzia, with the valley opening away below.',
            de: 'In den Fels gehauene Kammern und eine steinerne Kirche in Vardzia, darunter öffnet sich das Tal.',
        ...
        },
        {
          ...
          locality: 'Vardzia', region: 'Samtskhe-Javakheti', geo: { lat: 41.3811, lng: 43.2847 },
          name: {
            en: 'Cave chambers and stairways at Vardzia above the Mtkvari river gorge, Samtskhe-Javakheti, Georgia',
            de: 'Höhlenkammern und Treppen in Vardzia über der Schlucht des Mtkwari, Samtskhe-Javakheti, Georgien',
            fr: "Chambres troglodytes et escaliers à Vardzia au-dessus des gorges du Mtkvari, Samtskhe-Javakheti, Géorgie",
            es: 'Cámaras rupestres y escaleras en Vardzia sobre el desfiladero del río Mtkvari, Samtskhe-Javakheti, Georgia',
            nl: 'Grotkamers en trappen bij Vardzia boven de kloof van de rivier de Mtkvari, Samtskhe-Javakheti, Georgië',
            cs: 'Jeskynní komory a schodiště ve Vardzii nad soutěskou řeky Mtkvari, Samtskhe-Javakheti, Gruzie',
            pl: 'Jaskiniowe komory i schody w Vardzii nad wąwozem rzeki Mtkvari, Samtskhe-Javakheti, Gruzja',
          },
          caption: {
            en: 'Rows of cave chambers and linking stairways run across the cliff at Vardzia, above the Mtkvari as it winds through the gorge.',
            de: 'Reihen von Höhlenkammern und verbindende Treppen ziehen sich über die Felswand von Vardzia, darunter windet sich der Mtkwari durch die Schlucht.',
            fr: "Des rangées de chambres troglodytes et les escaliers qui les relient parcourent la falaise de Vardzia, au-dessus du Mtkvari qui serpente dans les gorges.",
            es: 'Hileras de cámaras rupestres y las escaleras que las conectan recorren el acantilado de Vardzia, sobre el Mtkvari que serpentea por el desfiladero.',
            nl: 'Rijen grotkamers en verbindende trappen lopen over de rotswand van Vardzia, boven de Mtkvari die door de kloof kronkelt.',
            cs: 'Řady jeskynních komor a spojujících schodišť se táhnou po skalní stěně Vardzie, pod nimi se Mtkvari vine soutěskou.',
            pl: 'Rzędy jaskiniowych komór i łączących je schodów biegną po ścianie skalnej Vardzii, a poniżej Mtkvari wije się wąwozem.',
        ...
        },
        {
          base: 'khertvisi-fortress-towers-georgia', width: 1448, height: 1086,
          anchor: 'inline-khertvisi',
          // The photograph does NOT show the two-river confluence its paragraph
          // mentions, so neither the caption nor the description claims it.
          description: 'The towers and curtain walls of Khertvisi Fortress on its ridge on the road to Vardzia, Samtskhe-Javakheti, Georgia.',
          locationName: 'Khertvisi Fortress, Aspindza Municipality, Samtskhe-Javakheti, Georgia',
          locality: 'Aspindza Municipality', region: 'Samtskhe-Javakheti', geo: { lat: 41.47778, lng: 43.28528 },
          name: {
            en: 'The towers and curtain walls of Khertvisi Fortress on its ridge, Samtskhe-Javakheti, Georgia',
            ...
            fr: "Les tours et les courtines de la forteresse de Khertvisi sur sa crête, Samtskhe-Javakheti, Géorgie",
            es: 'Las torres y murallas de la fortaleza de Khertvisi sobre su cresta, Samtskhe-Javakheti, Georgia',
            // `fort`, not the sibling guide's `vesting`: this page's body says fort.
            nl: 'De torens en muren van het fort Khertvisi op zijn bergrug, Samtskhe-Javakheti, Georgië',
            cs: 'Věže a hradby pevnosti Khertvisi na jejím hřebeni, Samtskhe-Javakheti, Gruzie',
            pl: 'Wieże i mury twierdzy Khertvisi na grani, Samtskhe-Javakheti, Gruzja',
          },
          caption: {
            en: 'Khertvisi Fortress holds its ridge on the road to Vardzia, its towers and curtain walls following the rock.',
            de: 'Die Festung Khertvisi behauptet ihren Bergrücken an der Straße nach Vardzia, ihre Türme und Mauern folgen dem Fels.',
            fr: "La forteresse de Khertvisi tient sa crête sur la route de Vardzia, ses tours et ses courtines épousant le rocher.",
            es: 'La fortaleza de Khertvisi domina su cresta en el camino a Vardzia, con torres y murallas que siguen la roca.',
            nl: 'Het fort Khertvisi beheerst zijn bergrug aan de weg naar Vardzia, met torens en muren die de rots volgen.',
            cs: 'Pevnost Khertvisi drží svůj hřeben na cestě do Vardzia, její věže a hradby sledují skálu.',
            pl: 'Twierdza Khertvisi trzyma swoją grań przy drodze do Vardzii, a jej wieże i mury podążają za skałą.',
          },
        },
      ],
      address: { addressRegion: 'Samtskhe-Javakheti' },
  ...
  },
  {
    ...
    // Hero: the seafront skyline seen across the pebble beach (owner's own photo), via
    // the .hero--batumi image-set() ladder (styles.css). REPLACES the previous
    // working-port view (batumi-black-sea-port-georgia — tour boat, cranes, cargo
    // quay), which was this page's only user and has been deleted along with the
    // parasailing inline. Native 4:3 (1448x1086), just under the 1600 rung, so the
    // ladder is exactly 768/1200/1448 with the top breakpoint at min-width:1200. NO
    // 1600/2400 rung, no upscale. `background-position: center center`; the blue-sky
    // upper band is the H1 zone. No extra scrim — the shared .coverme::after overlay
    // (rgba(0,0,0,0.35)) keeps the centre-anchored H1 legible. `image`/`imageAvif` =
    // the 1448 top rung → ImageObject contentUrl. Served from /images/batumi/ (the
    // folder the Europe Square set introduced), not /images/files/.
    // NOTE: only the sphere-topped Alphabet Tower is named — the package leaves the
    // other towers generic to avoid mis-identifying them. Do not add names here.
    image: '/images/batumi/batumi-skyline-beach-georgia-1448.webp',
    imageAvif: '/images/batumi/batumi-skyline-beach-georgia-1448.avif',
    heroClass: 'hero--batumi',
    // LCP hero preload — the 1200 AVIF (the rung the ladder serves at 768-1199px),
    // fetchpriority=high (via CityPage/useSEO + prerender.js).
    heroPreload: '/images/batumi/batumi-skyline-beach-georgia-1200.avif',
    // Dedicated 1.91:1 social-share image (og:image / twitter:image), .jpg default.
    // A matching -og.webp ships alongside but is unreferenced: useSEO/prerender emit
    // a single og:image.
    ogImage: { src: '/images/batumi/batumi-skyline-beach-georgia-og.jpg', width: 1200, height: 630 },
    // Hero image SEO/AEO metadata (owner's own photo → brand credit, set by CityPage).
    // Hero is a CSS background, so the localized alt lives here and feeds og:image:alt/
    // twitter:image:alt per locale; the `caption` map feeds the hero ImageObject
    // caption. Verbatim from batumi-city-SEO-package.md. `imageId: 'hero-image'` makes
    // CityPage emit the ImageObject `@id` …#hero-image (page-scoped), so the swap
    // reuses the same node id the old hero had. width/height = 1448 rung.
    // contentLocation = name + Batumi/Adjara/GE address + the city geo.
    imageMeta: {
      width: 1448, height: 1086, imageId: 'hero-image',
      name: 'Batumi seafront skyline across the pebble beach, Adjara, Georgia',
      description: "Batumi's Black Sea seafront seen from the pebble beach: the city's modern skyline of glass high-rise towers, including the sphere-topped Alphabet Tower, rising beyond the palm-lined boulevard under a blue sky with scattered cloud. Batumi is the capital of the Adjara region and Georgia's main Black Sea port and resort city, in Georgia (the country).",
      locationName: 'Batumi, Adjara, Georgia',
    ...
    // Five contextual inline body photos (owner's own), rendered by CityPage's
    // data-driven portraitInlines mechanism as real <figure class="body-img"> blocks
    // (landscape via `portrait: false`) placed between sections by `afterChunk`. The
    // body splits into 11 chunks at each <h2> and the SAME section order holds in all
    // 7 locales, so these indices are locale-independent — no pages.json edit is
    // needed and no body copy is touched. The renderer resolves ONE image per chunk
    // index, so the five occupy five distinct chunks:
    //   1 "Is Batumi worth visiting?"        → pebble beach  (¶ "beaches are shingle")
    //   2 "The historic center…"             → sunset        (¶ "on warm evenings")
    //   3 "Batumi Boulevard and the seafront"→ boulevard     (¶ names the fountains)
    //   4 "Contemporary architecture…"       → Ferris wheel  (see NOTE below)
    //   9 "Best time to visit Batumi"        → sea waves     (¶ "warm enough to swim")
    // ⚠️ NOTE: no locale's body mentions a Ferris wheel, an amusement park or a
    // sunset. Chunk 4 is the page's only night-leisure context ("waterfront
    // entertainment complexes", "summer leisure tourism"), and chunk 2's "warm
    // evenings" is the only evening anchor. Body copy was deliberately NOT rewritten
    // to suit the images.
    // All landscape, ladder 768/1200/1448 — EXCEPT the Boulevard shot whose native is
    // 1445x1089, so its ladder is 768/1200/1445. No 1600/2400 anywhere, no upscale.
    // `dir` points them at /images/batumi/ instead of the default /images/files/.
    // Each emits one inline ImageObject: stable @id, brand credit, NO
    // representativeOfPage (the hero stays representative), contentLocation
    // name + Batumi/Adjara/GE + city geo. loading=lazy, decoding=async, no
    // fetchpriority, no OG. Strings verbatim from batumi-city-SEO-package.md.
    portraitInlines: [
      {
        base: 'batumi-pebble-beach-georgia', width: 1448, height: 1086, afterChunk: 1,
        anchor: 'inline-pebble-beach', portrait: false, widths: [768, 1200, 1448],
        dir: '/images/batumi',
        locationName: 'Batumi, Adjara, Georgia',
        locality: 'Batumi', region: 'Adjara', geo: { lat: 41.6500, lng: 41.6367 },
        alt: {
          en: "People relaxing on Batumi's pebble beach beside the Black Sea under a bright, partly cloudy sky, Adjara, Georgia",
          de: 'Menschen entspannen sich an Batumis Kieselstrand am Schwarzen Meer unter einem hellen, teils bewölkten Himmel, Adscharien, Georgien',
          fr: 'Des gens se détendent sur la plage de galets de Batumi au bord de la mer Noire sous un ciel lumineux et partiellement nuageux, Adjarie, Géorgie',
          es: 'Gente descansando en la playa de guijarros de Batumi junto al mar Negro bajo un cielo luminoso y parcialmente nublado, Adjaria, Georgia',
          nl: 'Mensen ontspannen op het kiezelstrand van Batumi aan de Zwarte Zee onder een heldere, deels bewolkte hemel, Adzjarië, Georgië',
          cs: 'Lidé odpočívají na oblázkové pláži v Batumi u Černého moře pod jasnou, částečně zataženou oblohou, Adžárie, Gruzie',
          pl: 'Ludzie odpoczywają na kamienistej plaży w Batumi nad Morzem Czarnym pod jasnym, częściowo zachmurzonym niebem, Adżaria, Gruzja',
        },
        caption: {
          en: "Batumi's pebble beach on a summer afternoon, with visitors gathered along the Black Sea shoreline.",
          de: 'Batumis Kieselstrand an einem Sommernachmittag, mit Besuchern entlang der Küste des Schwarzen Meeres.',
          fr: "La plage de galets de Batumi par un après-midi d'été, avec des visiteurs installés le long du rivage de la mer Noire.",
          es: 'La playa de guijarros de Batumi una tarde de verano, con visitantes a lo largo de la orilla del mar Negro.',
          nl: 'Het kiezelstrand van Batumi op een zomermiddag, met bezoekers langs de kust van de Zwarte Zee.',
          cs: 'Oblázková pláž v Batumi za letního odpoledne, s návštěvníky podél pobřeží Černého moře.',
          pl: 'Kamienista plaża w Batumi w letnie popołudnie, z odwiedzającymi wzdłuż brzegu Morza Czarnego.',
        },
      },
      {
        base: 'batumi-black-sea-sunset-georgia', width: 1448, height: 1086, afterChunk: 2,
        anchor: 'inline-black-sea-sunset', portrait: false, widths: [768, 1200, 1448],
        dir: '/images/batumi',
        locationName: 'Batumi, Adjara, Georgia',
        locality: 'Batumi', region: 'Adjara', geo: { lat: 41.6500, lng: 41.6367 },
        alt: {
          en: 'The sun setting into the Black Sea through breaks in dark clouds, casting a red glow over the water off Batumi, Georgia',
          de: 'Die Sonne versinkt durch Lücken in dunklen Wolken im Schwarzen Meer und taucht das Wasser vor Batumi in rotes Licht, Georgien',
          fr: "Le soleil se couchant sur la mer Noire à travers des trouées de nuages sombres, teintant l'eau de rouge au large de Batumi, Géorgie",
          es: 'El sol poniéndose en el mar Negro a través de claros entre nubes oscuras, tiñendo de rojo el agua frente a Batumi, Georgia',
          nl: 'De zon die door openingen in donkere wolken in de Zwarte Zee ondergaat en het water voor Batumi rood kleurt, Georgië',
          cs: 'Slunce zapadající do Černého moře skrz trhliny v tmavých mracích, které zalévá vodu u Batumi rudou září, Gruzie',
          pl: 'Słońce zachodzące w Morzu Czarnym przez prześwity w ciemnych chmurach, zabarwiające wodę u wybrzeży Batumi na czerwono, Gruzja',
        },
        caption: {
          en: 'Sunset over the Black Sea at Batumi, the sun dropping through a band of cloud to redden the horizon above the surf.',
          de: 'Sonnenuntergang über dem Schwarzen Meer bei Batumi, während die Sonne durch ein Wolkenband sinkt und den Horizont über der Brandung rot färbt.',
          fr: "Coucher de soleil sur la mer Noire à Batumi, le soleil descendant à travers une bande de nuages pour rougir l'horizon au-dessus des vagues.",
          es: 'Atardecer sobre el mar Negro en Batumi, con el sol descendiendo a través de una franja de nubes para enrojecer el horizonte sobre el oleaje.',
          nl: 'Zonsondergang boven de Zwarte Zee bij Batumi, terwijl de zon door een wolkenband zakt en de horizon boven de branding rood kleurt.',
          cs: 'Západ slunce nad Černým mořem u Batumi, kdy slunce klesá skrz pás mraků a barví obzor nad příbojem doruda.',
          pl: 'Zachód słońca nad Morzem Czarnym w Batumi, gdy słońce opada przez pas chmur i czerwieni horyzont nad falami.',
        },
      },
      {
        // Native 1445x1089 (NOT 1448x1086) → ladder 768/1200/1445. The only image in
        // this set with a 1445 top rung; do not "normalise" it to 1448.
        base: 'batumi-boulevard-fountains-night-georgia', width: 1445, height: 1089, afterChunk: 3,
        anchor: 'inline-boulevard-fountains', portrait: false, widths: [768, 1200, 1445],
        dir: '/images/batumi',
        locationName: 'Batumi, Adjara, Georgia',
        locality: 'Batumi', region: 'Adjara', geo: { lat: 41.6500, lng: 41.6367 },
        alt: {
          en: 'Illuminated dancing fountains on Batumi Boulevard at night, with the checkerboard-paved promenade and lit high-rises, Georgia',
          de: 'Beleuchtete tanzende Fontänen am Boulevard von Batumi bei Nacht, mit der schachbrettartig gepflasterten Promenade und beleuchteten Hochhäusern, Georgien',
          fr: 'Fontaines dansantes illuminées sur le boulevard de Batumi la nuit, avec la promenade au pavage en damier et des immeubles éclairés, Géorgie',
          es: 'Fuentes danzantes iluminadas en el bulevar de Batumi de noche, con el paseo de pavimento ajedrezado y edificios altos iluminados, Georgia',
          nl: 'Verlichte dansende fonteinen op de boulevard van Batumi bij nacht, met de dambordvormig geplaveide promenade en verlichte hoogbouw, Georgië',
          cs: 'Osvětlené tančící fontány na bulváru v Batumi v noci, se šachovnicově dlážděnou promenádou a osvětlenými výškovými budovami, Gruzie',
          pl: 'Podświetlone tańczące fontanny na bulwarze w Batumi nocą, z szachownicowo brukowaną promenadą i oświetlonymi wieżowcami, Gruzja',
        },
        caption: {
          en: "The dancing fountains of Batumi Boulevard after dark, reflecting off the promenade's checkerboard paving beneath the illuminated seafront towers.",
          de: 'Die tanzenden Fontänen des Boulevards von Batumi bei Nacht, die sich auf dem schachbrettartig gepflasterten Weg unter den beleuchteten Uferhochhäusern spiegeln.',
          fr: 'Les fontaines dansantes du boulevard de Batumi la nuit, qui se reflètent sur le pavage en damier de la promenade sous les tours illuminées du front de mer.',
          es: 'Las fuentes danzantes del bulevar de Batumi de noche, reflejándose en el pavimento ajedrezado del paseo bajo las torres iluminadas del frente marítimo.',
          nl: 'De dansende fonteinen van de boulevard van Batumi bij nacht, weerspiegeld op de dambordvormige bestrating van de promenade onder de verlichte kusttorens.',
          cs: 'Tančící fontány na bulváru v Batumi v noci, odrážející se na šachovnicové dlažbě promenády pod osvětlenými pobřežními věžemi.',
          pl: 'Tańczące fontanny bulwaru w Batumi nocą, odbijające się na szachownicowym bruku promenady pod oświetlonymi nadmorskimi wieżami.',
        },
      },
      {
        base: 'batumi-ferris-wheel-night-georgia', width: 1448, height: 1086, afterChunk: 4,
        anchor: 'inline-ferris-wheel', portrait: false, widths: [768, 1200, 1448],
        dir: '/images/batumi',
        locationName: 'Batumi, Adjara, Georgia',
        locality: 'Batumi', region: 'Adjara', geo: { lat: 41.6500, lng: 41.6367 },
        alt: {
          en: "A brightly lit Ferris wheel glowing in rainbow colours at night beside palm trees in Batumi's seaside park, Georgia",
          de: 'Ein hell erleuchtetes Riesenrad, das nachts in Regenbogenfarben leuchtet, neben Palmen im Küstenpark von Batumi, Georgien',
          fr: "Une grande roue vivement éclairée aux couleurs de l'arc-en-ciel la nuit, près des palmiers dans le parc balnéaire de Batumi, Géorgie",
          es: 'Una noria brillantemente iluminada con colores del arcoíris de noche, junto a palmeras en el parque costero de Batumi, Georgia',
          nl: "Een felverlicht reuzenrad dat 's nachts in regenboogkleuren gloeit, naast palmbomen in het kustpark van Batumi, Georgië",
          cs: 'Jasně osvětlené ruské kolo zářící v noci duhovými barvami vedle palem v přímořském parku v Batumi, Gruzie',
          pl: 'Jaskrawo oświetlony diabelski młyn świecący nocą tęczowymi barwami obok palm w nadmorskim parku w Batumi, Gruzja',
        },
        caption: {
          en: "The illuminated Ferris wheel in Batumi's seaside park, lighting up the palms along the Black Sea boulevard after dark.",
          de: 'Das beleuchtete Riesenrad im Küstenpark von Batumi, das nach Einbruch der Dunkelheit die Palmen entlang des Schwarzmeer-Boulevards erhellt.',
          fr: 'La grande roue illuminée du parc balnéaire de Batumi, qui éclaire les palmiers du boulevard de la mer Noire à la tombée de la nuit.',
          es: 'La noria iluminada del parque costero de Batumi, que ilumina las palmeras del bulevar del mar Negro al caer la noche.',
          nl: 'Het verlichte reuzenrad in het kustpark van Batumi, dat na zonsondergang de palmen langs de Zwarte Zee-boulevard verlicht.',
          cs: 'Osvětlené ruské kolo v přímořském parku v Batumi, které po setmění rozzáří palmy podél černomořského bulváru.',
          pl: 'Oświetlony diabelski młyn w nadmorskim parku w Batumi, rozświetlający palmy wzdłuż czarnomorskiego bulwaru po zmroku.',
        },
      },
      {
        base: 'batumi-black-sea-waves-georgia', width: 1448, height: 1086, afterChunk: 9,
        anchor: 'inline-black-sea-waves', portrait: false, widths: [768, 1200, 1448],
        dir: '/images/batumi',
        locationName: 'Batumi, Adjara, Georgia',
        locality: 'Batumi', region: 'Adjara', geo: { lat: 41.6500, lng: 41.6367 },
        alt: {
          en: "Waves of the Black Sea breaking on Batumi's smooth pebble beach under a blue sky with white clouds, Georgia",
          de: 'Wellen des Schwarzen Meeres brechen an Batumis glattem Kieselstrand unter blauem Himmel mit weißen Wolken, Georgien',
          fr: 'Les vagues de la mer Noire déferlant sur la plage de galets lisses de Batumi sous un ciel bleu parsemé de nuages blancs, Géorgie',
          es: 'Olas del mar Negro rompiendo en la playa de guijarros lisos de Batumi bajo un cielo azul con nubes blancas, Georgia',
          nl: 'Golven van de Zwarte Zee breken op het gladde kiezelstrand van Batumi onder een blauwe lucht met witte wolken, Georgië',
          cs: 'Vlny Černého moře se tříští o hladkou oblázkovou pláž v Batumi pod modrou oblohou s bílými mraky, Gruzie',
          pl: 'Fale Morza Czarnego rozbijające się o gładką kamienistą plażę w Batumi pod błękitnym niebem z białymi chmurami, Gruzja',
        },
        caption: {
          en: "The Black Sea rolling onto Batumi's pebble shore — the smooth stones that give the city's beaches their character.",
          de: 'Das Schwarze Meer rollt an Batumis Kieselstrand – die glatten Steine, die den Stränden der Stadt ihren Charakter geben.',
          fr: 'La mer Noire venant se briser sur le rivage de galets de Batumi — les pierres lisses qui donnent leur caractère aux plages de la ville.',
          es: 'El mar Negro rompiendo en la orilla de guijarros de Batumi: las piedras lisas que dan carácter a las playas de la ciudad.',
          nl: 'De Zwarte Zee rolt op het kiezelstrand van Batumi — de gladde stenen die de stranden van de stad hun karakter geven.',
          cs: 'Černé moře naráží na oblázkové pobřeží Batumi — hladké kameny, které dávají plážím města jejich ráz.',
          pl: 'Morze Czarne uderzające o kamienisty brzeg Batumi — gładkie kamienie, które nadają plażom miasta charakter.',
        },
      },
    ],
    thingsToDo: {
...
export const sites = [
  ...
  },
  {
    ...
    // Two inline body photos (our own) rendered as real <figure class="body-img">
    // blocks in the per-locale content, each with a stable @id via SitePage
    // inlineImageObjects (no `w` suffix, never representativeOfPage — the hero
    // keeps that). The valley view replaced the earlier 16:9 city-body-figure of
    // the same subject; the Prince's Church is a new figure in the religion
    // section. Localized name/caption; approximate geo kept (as the other
    // Uplistsikhe inlines carry geo). Alt/caption verbatim from the image package.
    inlineImageObjects: [
      {
        base: 'uplistsikhe-princes-church-gori-georgia', width: 1448, height: 1086, anchor: 'inline-princes-church',
        name: { en: 'The 10th-century Prince\'s Church rising above the rock-cut caves of Uplistsikhe near Gori, Georgia', de: 'Die Fürstenkirche aus dem 10. Jahrhundert über den in Fels gehauenen Höhlen von Uplisziche bei Gori, Georgien', fr: 'L\'église du Prince du Xe siècle dominant les grottes taillées dans la roche d\'Ouplistsikhé près de Gori, Géorgie', es: 'La iglesia del Príncipe del siglo X alzándose sobre las cuevas talladas en la roca de Uplistsije cerca de Gori, Georgia', nl: 'De 10e-eeuwse Prinsenkerk boven de in rots uitgehouwen grotten van Uplistsiche bij Gori, Georgië', cs: 'Knížecí kostel z 10. století tyčící se nad skalními jeskyněmi Uplisciche u Gori, Gruzie', pl: 'Kościół Księcia z X wieku wznoszący się nad wykutymi w skale jaskiniami Uplisciche koło Gori, Gruzja' },
        caption: { en: 'Crowning the cave town of Uplistsikhe is the Prince\'s Church, built of brick and stone in the 10th century — the only free-standing building among hundreds of chambers hewn straight from the rock over three thousand years.', de: 'Über der Höhlenstadt Uplisziche thront die Fürstenkirche, im 10. Jahrhundert aus Ziegel und Stein erbaut – das einzige frei stehende Gebäude inmitten hunderter Kammern, die über drei Jahrtausende direkt aus dem Fels gehauen wurden.', fr: 'Couronnant la cité troglodyte d\'Ouplistsikhé, l\'église du Prince fut bâtie en brique et pierre au Xe siècle — le seul édifice indépendant parmi des centaines de chambres taillées à même la roche depuis plus de trois mille ans.', es: 'Coronando la ciudad rupestre de Uplistsije está la iglesia del Príncipe, levantada en ladrillo y piedra en el siglo X: el único edificio exento entre cientos de cámaras talladas en la propia roca a lo largo de más de tres mil años.', nl: 'De grotstad Uplistsiche wordt bekroond door de Prinsenkerk, in de 10e eeuw gebouwd van baksteen en steen — het enige vrijstaande gebouw tussen honderden kamers die in meer dan drieduizend jaar recht uit de rots zijn gehouwen.', cs: 'Jeskynní město Uplisciche korunuje Knížecí kostel, postavený v 10. století z cihel a kamene – jediná volně stojící stavba mezi stovkami komor vytesaných přímo do skály po více než tři tisíce let.', pl: 'Jaskiniowe miasto Uplisciche wieńczy Kościół Księcia, wzniesiony z cegły i kamienia w X wieku — jedyny wolnostojący budynek wśród setek komór kutych wprost w skale przez ponad trzy tysiące lat.' },
        description: 'The 10th-century Prince\'s Church (Uplistsulis Eklesia) rising above the rock-cut caves of Uplistsikhe cave town, near Gori, Shida Kartli, Georgia.',
        locationName: 'Uplistsikhe', locality: 'Uplistsikhe', region: 'Shida Kartli', geo: { lat: 41.9686, lng: 44.2072 },
      },
      {
        base: 'uplistsikhe-mtkvari-valley-view-georgia', width: 1448, height: 1086, anchor: 'inline-valley-view',
        name: { en: 'The carved rock terraces of Uplistsikhe overlooking the green Mtkvari river valley near Gori, Georgia', de: 'Die behauenen Felsterrassen von Uplisziche mit Blick über das grüne Tal des Mtkwari bei Gori, Georgien', fr: 'Les terrasses rocheuses taillées d\'Ouplistsikhé dominant la verte vallée de la Mtkvari près de Gori, Géorgie', es: 'Las terrazas talladas en la roca de Uplistsije sobre el verde valle del río Mtkvari cerca de Gori, Georgia', nl: 'De uitgehouwen rotsterrassen van Uplistsiche met uitzicht over het groene dal van de Mtkvari bij Gori, Georgië', cs: 'Vytesané skalní terasy Uplisciche s výhledem na zelené údolí řeky Mtkvari u Gori, Gruzie', pl: 'Wykute w skale tarasy Uplisciche z widokiem na zieloną dolinę rzeki Mtkwari koło Gori, Gruzja' },
        caption: { en: 'From the top of Uplistsikhe the whole plan of the rock city opens up — halls, streets and cave-mouths carved into the hillside — above the broad green valley of the Mtkvari that made this a Silk Road stronghold.', de: 'Vom höchsten Punkt Uplischiches öffnet sich der ganze Grundriss der Felsenstadt – Hallen, Straßen und Höhleneingänge in den Hang gehauen – über dem breiten grünen Tal des Mtkwari, das diesen Ort zu einer Festung an der Seidenstraße machte.', fr: 'Du sommet d\'Ouplistsikhé se déploie tout le plan de la cité rocheuse — salles, rues et entrées de grottes taillées dans le versant — au-dessus de la large vallée verte de la Mtkvari qui en fit un bastion de la route de la Soie.', es: 'Desde lo alto de Uplistsije se despliega todo el trazado de la ciudad rupestre —salas, calles y bocas de cueva talladas en la ladera— sobre el amplio valle verde del Mtkvari que la convirtió en un bastión de la Ruta de la Seda.', nl: 'Vanaf de top van Uplistsiche ontvouwt zich het hele plan van de rotsstad — zalen, straten en grotopeningen in de helling gehouwen — boven het brede groene dal van de Mtkvari dat dit tot een bolwerk aan de zijderoute maakte.', cs: 'Z vrcholu Uplisciche se rozevírá celý půdorys skalního města – sály, ulice a vchody do jeskyní vytesané do svahu – nad širokým zeleným údolím Mtkvari, jež z něj učinilo pevnost na Hedvábné stezce.', pl: 'Ze szczytu Uplisciche rozpościera się cały plan skalnego miasta — sale, ulice i wejścia do jaskiń wykute w zboczu — nad szeroką zieloną doliną Mtkwari, która uczyniła je twierdzą Jedwabnego Szlaku.' },
        description: 'The carved rock terraces of Uplistsikhe overlooking the green Mtkvari (Kura) river valley, near Gori, Shida Kartli, Georgia.',
        locationName: 'Uplistsikhe', locality: 'Uplistsikhe', region: 'Shida Kartli', geo: { lat: 41.9686, lng: 44.2072 },
      },
    ],
  },
