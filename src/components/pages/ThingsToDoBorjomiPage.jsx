...
const HERO_IMAGE = '/images/files/borjomi-town.jpg'
const SITE_URL = 'https://www.hikasustravel.com'
const PATH = 'things-to-do-in-borjomi'

// Main attractions covered on the page (for the ItemList / TouristAttraction schema).
const ATTRACTIONS = [
  'Borjomi Central Park',
  'Borjomi Mineral Water Spring',
  'Borjomi Sulfur Pools',
  'Borjomi Cable Car',
  'Borjomi-Kharagauli National Park',
  'Likani Romanov Palace Grounds',
]

export default function ThingsToDoBorjomiPage() {
  const { pages } = useContext(I18nContext)
  const { lang } = useLang()
  // Fall back to English content until per-language translations are added.
  const page = pages.thingsToDoBorjomi || enPages.thingsToDoBorjomi
  const seo = getSEO('thingsToDoBorjomi', lang)
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Things to Do in Borjomi', item: url },
          ],
        },
        {
          '@type': 'ItemList',
          name: 'Things to Do in Borjomi',
