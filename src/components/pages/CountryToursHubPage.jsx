...
const SEO_KEY = { armenia: 'toursArmenia', azerbaijan: 'toursAzerbaijan', caucasus: 'toursCaucasus' }
const TITLE_KEY = { armenia: 'home.hubTitleArmenia', azerbaijan: 'home.hubTitleAzerbaijan', caucasus: 'home.hubTitleCaucasus' }
const INTRO_KEY = { armenia: 'home.hubIntroArmenia', azerbaijan: 'home.hubIntroAzerbaijan', caucasus: 'home.hubIntroCaucasus' }
...
/**
 * Shared template for the three new country tours hubs (/tours/armenia,
 * /tours/azerbaijan, /tours/caucasus). Indexability and content are both
 * driven by the SAME tour-count check (`countryHasAnyTours`) — no manual
 * toggle. Adding a tour with `country: "<country>"` in src/data/tours.js is
 * the only step required to flip a hub from coming-soon/noindex to a real,
 * indexed tour listing.
 */
