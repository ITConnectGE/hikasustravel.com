...
const PATH = 'things-to-do-in-tbilisi'
...
export default function ThingsToDoTbilisiPage() {
  const { pages } = useContext(I18nContext)
  const { lang } = useLang()
  // Fall back to English content until per-language translations are added.
  const page = pages.thingsToDoTbilisi || enPages.thingsToDoTbilisi
  const seo = getSEO('thingsToDoTbilisi', lang)
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Things to Do in Tbilisi', item: url },
          ],
        },
        {
          '@type': 'ItemList',
          name: 'Things to Do in Tbilisi',
