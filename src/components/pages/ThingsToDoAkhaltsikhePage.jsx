...
const PATH = 'things-to-do-in-akhaltsikhe'
...
export default function ThingsToDoAkhaltsikhePage() {
  const { pages } = useContext(I18nContext)
  const { lang } = useLang()
  // Fall back to English content until per-language translations are added.
  const page = pages.thingsToDoAkhaltsikhe || enPages.thingsToDoAkhaltsikhe
  const seo = getSEO('thingsToDoAkhaltsikhe', lang)
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Things to Do in Akhaltsikhe', item: url },
          ],
        },
        {
          '@type': 'ItemList',
          name: 'Things to Do in Akhaltsikhe',
          itemListElement: ATTRACTIONS.map((name, i) => ({
            ...
            item: {
              ...
              address: {
                '@type': 'PostalAddress',
                addressRegion: 'Samtskhe-Javakheti',
                addressCountry: 'GE',
              },
            },
          })),
