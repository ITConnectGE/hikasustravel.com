...
export default function ThingsToDoAmbrolauriPage() {
  const { pages } = useContext(I18nContext)
  const { lang } = useLang()
  // Fall back to English content until per-language translations are added.
  const page = pages.thingsToDoAmbrolauri || enPages.thingsToDoAmbrolauri
  const seo = getSEO('thingsToDoAmbrolauri', lang)
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Things to Do in Ambrolauri', item: url },
          ],
        },
        {
          '@type': 'ItemList',
          name: 'Things to Do in Ambrolauri',
