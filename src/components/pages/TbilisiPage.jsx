...
export default function TbilisiPage() {
  ...
  const page = pages.tbilisi || enPages.tbilisi
  const seo = getSEO('tbilisi', lang)
  ...
  const jsonLd = useMemo(() => {
    const url = `${SITE_URL}/${lang}/destinations/tbilisi`
    return {
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Tbilisi', item: url },
          ],
        },
        {
          '@type': 'FAQPage',
  ...
  useSEO({ ...seo, lang, path: 'destinations/tbilisi', image: HERO_IMAGE, jsonLd })
