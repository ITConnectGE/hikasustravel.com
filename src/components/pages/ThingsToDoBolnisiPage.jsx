...
// Placeholder hero — replace with a real Bolnisi photo when available.
const HERO_IMAGE = '/images/files/georgia-home.jpg'
const SITE_URL = 'https://www.hikasustravel.com'
const PATH = 'things-to-do-in-bolnisi'

// Main attractions covered on the page (for the ItemList / TouristAttraction schema).
const ATTRACTIONS = [
  'Bolnisi Sioni Cathedral',
  'German Heritage (Katharinenfeld)',
  'Dmanisi Archaeological Site',
  'Kvemo Kartli Countryside',
  'Local Markets and Life',
  'Kvemo Kartli Wineries',
]

export default function ThingsToDoBolnisiPage() {
  const { pages } = useContext(I18nContext)
  const { lang } = useLang()
  // Fall back to English content until per-language translations are added.
  const page = pages.thingsToDoBolnisi || enPages.thingsToDoBolnisi
  const seo = getSEO('thingsToDoBolnisi', lang)
      ...
      '@graph': [
        ...
        },
        {
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Things to Do in Bolnisi', item: url },
          ],
        },
        {
          '@type': 'ItemList',
          name: 'Things to Do in Bolnisi',
